...
*** Week 4
    ...
    |   - | I    | -     | -           | 3x2m   |     299.04 | 2m   | -                                  |
    |   - | I    | -     | -           | 3x1m   |     307.05 | 1m   | -                                  |
    |   5 | INT  | 3x20m | 245.64      | 2x10   |          - | 1m   | Constant                           |
    #+TBLFM: @2$4=$currentFTP*.94;%.0f
    #+TBLFM: @4$4=$currentFTP.95;%.0f
    #+TBLFM: @4$6=$currentFTP*1.17;%.0f
    #+TBLFM: @7$6=$currentFTP * 1.02
    #+TBLFM: @8$6=$currentFTP * 1.05
    #+TBLFM: @9$6=$currentFTP * 1.08
    #+TBLFM: @10$6=$currentFTP * 1.12
    #+TBLFM: @11$6=$currentFTP * 1.15
    #+TBLFM: @12$4=$currentFTP * .92
